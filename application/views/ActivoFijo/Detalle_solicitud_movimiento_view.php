<?php
  ...
  echo "<div class='content-form'>";
    ...
    echo "<div class='limit-content'>";
      echo form_open("/ActivoFijo/Detalle_solicitud_movimiento/RecibirDatos", $atributos);
  ...
  $buscar = array(
    ...
    'autocomplete' => 'off',
    'id' => 'buscar',
    'url' => 'index.php/ActivoFijo/Detalle_solicitud_movimiento/mostrarTabla/'.$nombre
  );
