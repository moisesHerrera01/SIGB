...
echo "<div style='text-align:center'>";
    ...
    echo "<h3><font color=black>6- Reporte de Movimiento por Oficina</font></h3>";
  echo "</div>";
echo "</div>";
...
echo "<div class='content-form'>";
  ...
  echo "<div class='limit-content'>";
    echo form_open("/ActivoFijo/Reportes/Movimientos_por_oficina/RecibirMovimientosOficina", $atributos);
