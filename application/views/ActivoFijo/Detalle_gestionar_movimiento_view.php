<?php
  ...
  echo "<div class='content-form'>";
    ...
    echo "<div class='limit-content'>";
      echo form_open("/ActivoFijo/Detalle_gestionar_movimiento/ActualizarDatos", $atributos);
  ...
  $buscar = array(
    ...
    'autocomplete' => 'off',
    'id' => 'buscar',
    'url' => 'index.php/ActivoFijo/Detalle_gestionar_movimiento/mostrarTabla/'.$nombre
  );
