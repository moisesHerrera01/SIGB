<?php
  ...
  echo form_open("/ActivoFijo/Aprobar_movimiento/ActualizarDatos", $atributos);
  ...
  $en= array(
      'name' => 'entrega',
      'placeholder' => 'Oficina que entrega',
      'class' => "form-control",
      'readonly'=>"readonly",
  );
  ...
  $re= array(
      'name' => 'recibe',
      'placeholder' => 'Oficina que recibe',
      'class' => "form-control",
      'readonly'=>"readonly",
  );
  ...
  echo "<div class='form-group'>";
    echo form_label('Oficina Entrega:', 'en', $atriLabel);
    echo "<div class='col-lg-10'>";
      echo form_input($en);
    echo "</div>";
  echo "</div>";
  ...
  echo "<div class='form-group'>";
    echo form_label('Oficina Recibe:', 're', $atriLabel);
    echo "<div class='col-lg-10'>";
      echo form_input($re);
    echo "</div>";
  echo "</div>";
  ...
  echo "<div class='form-group'>";
    echo form_label('Usuario Externo:', 'us', $atriLabel);
    echo "<div class='col-lg-10'>";
      echo form_input($us);
    echo "</div>";
  echo "</div>";
  ...
  echo "<a class=\"btn btn-warning\" onclick=\"limpiar(['fecha_actual', 'entrega','recibe','emplead',
  'tipo','usuario'], false, ['observacion'])\">Limpiar</a>";
...
echo "</div>";
  $buscar = array(
    ...
    'autocomplete' => 'off',
    'id' => 'buscar',
    'url' => 'index.php/ActivoFijo/Aprobar_movimiento/mostrarTabla'
  );
