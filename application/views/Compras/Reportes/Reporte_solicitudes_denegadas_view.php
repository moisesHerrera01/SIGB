...
echo "<div style='text-align:center'>";
    ...
    echo "<h3><font color=black>Reporte de solicitudes denegadas.</font></h3>";
  echo "</div>";
echo "</div>";
...
echo "<div class='content-form'>";
  ...
  echo "<div class='limit-content'>";
    echo form_open("/Compras/Reportes/Reporte_solicitudes_denegadas/Recibirfechas", $atributos);
