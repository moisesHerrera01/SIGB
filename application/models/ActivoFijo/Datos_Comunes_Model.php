<?php
  class Datos_comunes_model extends CI_Model{
   ...
   /*Reporte bienes por unidad*/
   public function obtenerBienesOficina($oficina,$porpagina = -1, $segmento = -1){
     $this->db->select('a.descripcion, a.modelo, d.nombre_marca, b.serie, a.color, b.id_empleado, b.codigo_anterior, b.codigo, a.codificar,
                      a.precio_unitario, c.nombre_oficina, b.id_bien')
              ->from('sic_datos_comunes a')
              ->join('sic_bien b', 'a.id_dato_comun = b.id_dato_comun')
              ->join('org_oficina c', 'c.id_oficina = b.id_oficina')
              ->join('sic_marcas d', 'a.id_marca = d.id_marca')
              ->where('b.id_oficina', $oficina);
    ...
    public function totalBienesOficina($oficina){
    ...
    public function obtenerBienesUnidad($seccion,$porpagina = -1,$segmento = -1) {
      $this->db->select('a.descripcion, a.modelo, d.nombre_marca, b.serie, a.color, b.id_empleado, b.codigo_anterior, b.codigo, a.codificar,
               ...
               ->join('org_oficina c', 'c.id_oficina = b.id_oficina')
               ->join('sic_marcas d', 'a.id_marca = d.id_marca')
               ->join('org_seccion_has_almacen e', 'c.id_seccion_has_almacen = e.id_seccion_has_almacen')
    ...
    public function obtenerBienesProyecto($proyecto,$porpagina,$segmento){
      $this->db->select('c.nombre_categoria,s.nombre_subcategoria,d.descripcion,d.modelo,d.id_doc_ampara,
                        ...
                        b.id_empleado,CONCAT_WS(" ",primer_nombre,segundo_nombre,primer_apellido,segundo_apellido) as nombre_empleado')
               ->from('sic_datos_comunes d')
               ->join('sic_bien b','d.id_dato_comun=b.id_dato_comun')
    ...
    public function obtenerBien($id){
       ...
       emp.primer_apellido,emp.segundo_apellido')
                ...
                ->join('org_oficina of','of.id_oficina=b.id_oficina')
                ->join('sir_empleado emp','emp.id_empleado=b.id_empleado')
                ->join('sic_subcategoria s', 's.id_subcategoria = d.id_subcategoria')
